...
def convert_clicks(alldata):
    ...
    return point_coords, point_labels, indexes, len(points)
...
if __name__ == "__main__":
    ...
    pretrained_ckpt = torch.load(checkpoint_path, map_location="cuda")['model']
    pretrained_ckpt = {k.replace('module.', ''): v for k, v in pretrained_ckpt.items()}
    ...
    for img_path in test_cases:
        ...
        point_coords, point_labels, indexes, n_points = convert_clicks(clicks)
        # preprocess
